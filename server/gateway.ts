...
const TIER_HEADERS: Record<CacheTier, string> = {
  ...
  'slow-browser': 'public, max-age=300, s-maxage=1800, stale-while-revalidate=300, stale-if-error=3600',
...
const TIER_CDN_CACHE: Record<CacheTier, string | null> = {
  ...
  'slow-browser': 'public, s-maxage=3600, stale-while-revalidate=900, stale-if-error=7200',
